...
async function getInferredCompilerOptions(ts, configuration) {
    var _a;
    let [implicitProjectConfig_1, implicitProjectConfig_2] = (_a = await (configuration === null || configuration === void 0 ? void 0 : configuration.getConfiguration([
