...
exports.resolveVueCompilerOptions = exports.getDocumentSafely = exports.eqSet = exports.getWordRange = exports.isInsideRange = exports.notEmpty = exports.languageIdToSyntax = exports.syntaxToLanguageId = exports.sleep = void 0;
...
function resolveVueCompilerOptions(rawOptions, rootPath) {
    ...
    if (templateOptionsPath) {
        console.log(templateOptionsPath, path.isAbsolute(templateOptionsPath), rootPath, require.resolve(templateOptionsPath, { paths: [rootPath] }));
