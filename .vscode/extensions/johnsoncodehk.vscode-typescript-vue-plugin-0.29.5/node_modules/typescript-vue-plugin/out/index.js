...
function createProxyHost(ts, info) {
    ...
    const host = {
        ...
        getVueCompilationSettings: () => { var _a, _b; return shared.resolveVueCompilerOptions((_b = (_a = parsedCommandLine === null || parsedCommandLine === void 0 ? void 0 : parsedCommandLine.raw) === null || _a === void 0 ? void 0 : _a.vueCompilerOptions) !== null && _b !== void 0 ? _b : {}, info.project.getCurrentDirectory()); },
    ...
    async function onAnyDriveFileUpdated(fileName) {
