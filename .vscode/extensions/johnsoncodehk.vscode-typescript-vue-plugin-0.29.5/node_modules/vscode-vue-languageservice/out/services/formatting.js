    ...
    async function getCssFormattingEdits(sourceFile, options) {
        ...
        for (const sourceMap of sourceFile.getCssSourceMaps()) {
            ...
            for (const cssEdit of cssEdits) {
                const vueEdit = (0, transforms_1.transformTextEdit)(cssEdit, cssRange => sourceMap.getSourceRange(cssRange.start, cssRange.end));
                if (vueEdit) {
                    result.push(vueEdit);
                }
            }
    ...
    async function getHtmlFormattingEdits(sourceFile, options) {
        ...
        for (const sourceMap of sourceFile.getHtmlSourceMaps()) {
            ...
            for (const htmlEdit of htmlEdits) {
                const vueEdit = (0, transforms_1.transformTextEdit)(htmlEdit, htmlRange => sourceMap.getSourceRange(htmlRange.start, htmlRange.end));
                if (vueEdit) {
                    result.push(vueEdit);
                }
            }
    ...
    async function getPugFormattingEdits(sourceFile, options) {
        ...
        for (const sourceMap of sourceFile.getPugSourceMaps()) {
            ...
            for (const pugEdit of pugEdits) {
                const vueEdit = (0, transforms_1.transformTextEdit)(pugEdit, pugRange => sourceMap.getSourceRange(pugRange.start, pugRange.end));
                if (vueEdit) {
                    result.push(vueEdit);
                }
            }
