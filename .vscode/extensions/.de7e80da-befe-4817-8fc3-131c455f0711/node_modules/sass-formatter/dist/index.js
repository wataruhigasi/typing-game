            ...
            if (suf_regex_1.isIgnore(line.get())) {
                ...
                if (line.isEmptyOrWhitespace ||
                    ...
                    STATE.setLocalContext({
                        ...
                        isAtKeyframes: suf_regex_1.isKeyframes(line.get()),
                        isReset: suf_regex_1.isReset(line.get()),
                        isAnd: suf_regex_1.isAnd(line.get()),
                        isProp: suf_regex_1.isProperty(line.get()),
                        isAdjacentSelector: suf_regex_1.isAdjacentSelector(line.get()),
                        isHtmlTag: suf_regex_1.isHtmlTag(line.get().trim().split(' ')[0]),
                        isClassOrIdSelector: suf_regex_1.isClassOrId(line.get()),
                        isAtExtend: suf_regex_1.isAtExtend(line.get()),
                        isInterpolatedProp: suf_regex_1.isInterpolatedProperty(line.get()),
                        isInclude: suf_regex_1.isInclude(line.get()),
                        isVariable: suf_regex_1.isVar(line.get()),
                        isImport: suf_regex_1.isAtImport(line.get()),
