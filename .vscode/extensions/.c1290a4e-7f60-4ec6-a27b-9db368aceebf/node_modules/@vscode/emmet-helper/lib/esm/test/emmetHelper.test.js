...
describe('Extract Abbreviations', () => {
    it('should extract abbreviations from document html', () => {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedRangeStartLine, expectedRangeStartChar, expectedRangeEndLine, expectedRangeEndChar, expectedFilter]) => {
            ...
            const result = extractAbbreviation(document, position);
            assert.ok(result);
    ...
    it('should extract abbreviations from document css', () => {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedRangeStartLine, expectedRangeStartChar, expectedRangeEndLine, expectedRangeEndChar, expectedFilter]) => {
            ...
            const result = extractAbbreviation(document, position, extractOptions);
            assert.ok(result);
            const { abbreviationRange, abbreviation, filter } = result;
            assert.strictEqual(expectedAbbr, abbreviation);
            assert.strictEqual(expectedRangeStartLine, abbreviationRange.start.line);
    ...
    it('should extract abbreviations from text', () => {
        ...
        testCases.forEach(([content, expectedAbbr, expectedFilter]) => {
            const result = extractAbbreviationFromText(content, 'html');
            assert.ok(result);
...
describe('Test variables settings', () => {
    ...
    it('should use variables from the extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const expandOptions = getExpandOptions('html', {});
        assert.strictEqual(expandOptions.variables['lang'], 'fr');
    }));
    it('should use given variables that override ones from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const variables = {
            lang: 'en',
            charset: 'UTF-8'
...
describe('Test custom snippets', () => {
    it('should use custom snippets for given syntax from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        assert.ok(expandOptionsWithCustomSnippets.snippets);
    ...
    it('should use custom snippets inherited from base syntax from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield updateExtensionsPath(extensionsPath);
        const expandOptionsWithCustomSnippets = getExpandOptions('css');
        const expandOptionsWithCustomSnippetsInheritedSyntax = getExpandOptions('scss');
        assert.ok(expandOptionsWithCustomSnippets.snippets);
        assert.ok(expandOptionsWithCustomSnippetsInheritedSyntax.snippets);
        assert.strictEqual(Object.keys(expandOptionsWithCustomSnippets.snippets).some(key => key === customSnippetKey), true);
        assert.strictEqual(Object.keys(expandOptionsWithCustomSnippetsInheritedSyntax.snippets).some(key => key === customSnippetKey), true);
    }));
    ...
    it('should throw error when snippets file from extensionsPath has invalid json', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should do nothing when non-existent extensionsPath is given', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(extensionsPath);
        assert.strictEqual(Object.keys(getExpandOptions('scss').snippets).some(key => key === customSnippetKey), true);
        try {
    ...
    it('should do nothing when directory with no snippets is given', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(extensionsPath);
    ...
    it('should use the first valid custom snippets from an array of extensions path', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath([]);
        const expandOptionsWithoutCustomSnippets = getExpandOptions('css');
        assert(!expandOptionsWithoutCustomSnippets.snippets);
    ...
    it('should override earlier snippets with later snippets', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should do nothing when all extensionsPath in the array are invalid', () => __awaiter(void 0, void 0, void 0, function* () {
...
describe('Test completions', () => {
    ...
    it('should not provide link:m as a suggestion', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not provide marginright as a suggestion SCSS', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should provide completions html', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedExpansionDocs, expectedExpansion]) => {
            ...
            assert.strictEqual((_a = completionList.items[0].textEdit) === null || _a === void 0 ? void 0 : _a.newText, expectedExpansion);
        });
    }));
    ...
    it('should provide completions for text that are prefix for snippets, ensure $ doesnt get escaped', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        testCases.forEach(([content, positionLine, positionChar]) => {
            ...
            assert.strictEqual((_a = completionList.items.find(x => x.label === 'link').textEdit) === null || _a === void 0 ? void 0 : _a.newText, '<link rel="stylesheet" href="${0}">');
            assert.strictEqual(completionList.items.find(x => x.label === 'link:css').documentation, '<link rel="stylesheet" href="style.css">');
            assert.strictEqual((_b = completionList.items.find(x => x.label === 'link:css').textEdit) === null || _b === void 0 ? void 0 : _b.newText, '<link rel="stylesheet" href="${2:style}.css">');
        });
    }));
    it('should provide completions for scss', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath([]);
        const testCases = [
            ['m:a', 0, 3]
        ];
    ...
    it('should provide completions with escaped $ in scss', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        testCases.forEach(([content, positionLine, positionChar]) => {
            ...
            assert.strictEqual((_a = completionList.items.find(x => x.label === 'background-image: $hello;').textEdit) === null || _a === void 0 ? void 0 : _a.newText, 'background-image: \\$hello;');
        });
    }));
    it('should provide completions with escaped $ in html', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedDoc, expectedSnippetText]) => {
            ...
            assert.strictEqual((_a = completionList.items.find(x => x.label === content).textEdit) === null || _a === void 0 ? void 0 : _a.newText, expectedSnippetText);
        });
    }));
    ...
    it('should provide completions for pascal-case tags when typing (jsx)', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath([]);
        const testCases = [
    ...
    it('should provide completions for lorem*2 with 2 lines', () => __awaiter(void 0, void 0, void 0, function* () {
