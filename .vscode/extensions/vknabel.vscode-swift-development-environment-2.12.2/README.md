...
![preview](https://github.com/vknabel/vscode-swift-development-environment/raw/HEAD/docs/preview.gif)
...
There are a lot of ways you could contribute to either this project or the Swift on VS Code itself. For more information head over to [CONTRIBUTING.md](https://github.com/vknabel/vscode-swift-development-environment/blob/HEAD/./CONTRIBUTING.md).
